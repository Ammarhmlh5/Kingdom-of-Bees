            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-amber-200">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 mt-2">أنشئ حساباً جديداً للبدء</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-300 bg-white/70"
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                <label className="flex items-center gap-2 cursor-pointer flex-1 p-3 border-2 rounded-xl transition-all duration-300 hover:border-amber-400"
                                    style={{ borderColor: formData.userType === 'OWNER' ? '#f59e0b' : '#d1d5db' }}>
                                    <input
                                        type="radio"
                                        name="userType"
                                        value="OWNER"
                                        ...
                                        disabled={isLoading}
                                    />
                                    <span className="text-sm font-medium">مالك منحل 👨‍🌾</span>
                                </label>
                                <label className="flex items-center gap-2 cursor-pointer flex-1 p-3 border-2 rounded-xl transition-all duration-300 hover:border-amber-400"
                                    style={{ borderColor: formData.userType === 'WORKER' ? '#f59e0b' : '#d1d5db' }}>
                                    <input
                                        type="radio"
                                        name="userType"
                                        value="WORKER"
                                        ...
                                        disabled={isLoading}
                                    />
                                    <span className="text-sm font-medium">عامل منحل 🐝</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 mt-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                            {isLoading ? (
                        ...
                        <button
                            ...
                            onClick={() => {
                                ...
                                setError('التسجيل عبر Google قريباً');
                            }}
                    ...
                    <div className="mt-8 text-center text-sm text-gray-500">
                        <p>لديك حساب بالفعل؟ <Link to="/login" className="text-amber-600 hover:underline font-medium">سجل دخولك</Link></p>
                    </div>
                </div>

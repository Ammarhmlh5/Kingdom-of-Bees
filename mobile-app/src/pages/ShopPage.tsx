...
const sections: ToolSection[] = [
  {
    ...
    items: [
      ...
      { name: '鸲ّة النحل', desc: 'أداة متعددة الاستخدام: فتح غطاء العسل، رفع الأطر، وإزالة البروبوليس. لا غنى عنها.', tip: 'اختر鸲ّة من الستانلس ستيل المتين' },
    ],
  },
  {
    id: 'harvest',
    ...
    items: [
      ...
      { name: 'أوعية التخزين', desc: 'حاويات بلاستيكية أو زجاجية محكمة الإغلاق. تُخزّن في مكان بارد وجاف远离 الشمس المباشرة.', tip: 'تجنب الأواني المعدنية التي قد تتفاعل مع العسل' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'مقارنة الأسعار', desc: 'قارن بين الموردين المحليين والمتاجر الإلكترونية. بعض الموردين يقدمون عروض للمبتدئين.', tip: ' Groups النحالين often have bulk purchase discounts' },
